...
class ChartBuilderServicePalaceTest {

    @Test
    void shouldWritePalaceInfoIntoChartExt() {
        ...
        assertEquals("乾", chartSnapshot.getPalace());
        assertEquals("金", chartSnapshot.getPalaceWuXing());
        assertEquals("乾", chartSnapshot.getExt().get("palace"));
        assertEquals("金", chartSnapshot.getExt().get("palaceWuXing"));
    }
}
