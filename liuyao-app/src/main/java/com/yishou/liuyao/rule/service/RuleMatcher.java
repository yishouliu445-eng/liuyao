...
public class RuleMatcher {
    ...
    private Object readValue(String target, RuleEvaluationContext context) {
        ...
        return switch (target) {
            ...
            case "USE_GOD_ADVANCE" -> context.getUseGodAdvance();
            ...
            case "HAS_MOVING_AFFECT_SHI" -> context.getHasMovingAffectShi();
            case "HIDDEN_USE_GOD_FOUND" -> context.getHiddenUseGodFound();
            case "FLY_SHEN_SUPPRESS" -> context.getFlyShenSuppress();
            case "HIDDEN_USE_GOD_SUPPORTED" -> context.getHiddenUseGodSupported();
            case "HIDDEN_USE_GOD_BROKEN" -> context.getHiddenUseGodBroken();
            case "HAS_FU_YIN" -> context.getHasFuYin();
            case "CHART_FU_YIN" -> context.getChartFuYin();
            case "HAS_FAN_YIN" -> context.getHasFanYin();
            case "CHART_FAN_YIN" -> context.getChartFanYin();
            case "HAS_NOBLEMAN" -> context.getHasNobleman();
            case "USE_GOD_WITH_NOBLEMAN" -> context.getUseGodWithNobleman();
            case "HAS_TRAVEL_HORSE" -> context.getHasTravelHorse();
            case "MOVING_WITH_TRAVEL_HORSE" -> context.getMovingWithTravelHorse();
            case "HAS_PEACH_BLOSSOM" -> context.getHasPeachBlossom();
            case "USE_GOD_WITH_PEACH_BLOSSOM" -> context.getUseGodWithPeachBlossom();
            case "HAS_WEN_CHANG" -> context.getHasWenChang();
            case "USE_GOD_WITH_WEN_CHANG" -> context.getUseGodWithWenChang();
            case "HAS_GENERAL_STAR" -> context.getHasGeneralStar();
            case "USE_GOD_WITH_GENERAL_STAR" -> context.getUseGodWithGeneralStar();
            case "HAS_JIE_SHA" -> context.getHasJieSha();
            case "MOVING_WITH_JIE_SHA" -> context.getMovingWithJieSha();
            case "HAS_DISASTER_SHA" -> context.getHasDisasterSha();
            case "MOVING_WITH_DISASTER_SHA" -> context.getMovingWithDisasterSha();
